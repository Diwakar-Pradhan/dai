          ...
          { messages.length === 0 ? (
            <>
              <div className="flex items-center gap-3">
                ...
                <p className="text-2xl font-medium">Hi, I am DAI</p>
              </div>
            ...
            <div ref={containerRef} className="relative flex flex-col items-center justify-start w-full mt-20 max-h-screen overflow-y-auto">
              <p className="fixed top-8 border border-transparent hover:border-gray-500/50 py-1 px-2 rounded-lg font-semibold md-6">{selectedChat.name}</p>
              {
